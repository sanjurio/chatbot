headers={"User-Agent":"Moziella/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/37.0.2062.120"}
import requests
from time import *
helpl=''
karts=[]
...
deb=['14CSL260','14MER137','14EEL133','14CSR098','14ITR021','14ISR029','14CER043','14CER075','14CER192','15CEL267','15MER102','15MER156','13ECR008','14ECR022','15ECR037','15EIL109','14CSR203','15CSR068','15CSL260','15CHL122','15BCR049','14BSR009','15ISR020','15ISR045','16CER076','16CEL257','16MER062','16AUR055','16EER049','16EEL138','16EIR017','16ITR035','16ITR053','16CMR007','16ESR002','16CIR009','16BIR012','16MCL018','16MCL055','17CER021','17CER104','17MER020','17MER030','17AUR051','17CSR026','17BSR058','17BSR059','17CMR002','17MMR001','17VLR002','17MBR008','17MBR037','17MBR102','17ISR026']
deb2={
